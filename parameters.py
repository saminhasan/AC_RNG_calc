LIPO_DIS_PER = 0.8
LIPO_SPEC_ENG = 100 * 3600 *  LIPO_DIS_PER # 100 Wh/Kg - 158 Wh/Kg > J / Kg
...
TOTAL_WEIGHT = PAYLOAD *2 + BATT_WEIGHT
print(BATT_WEIGHT)
VEHICLE_SPEC_POW_CON = 200 # 200 W/Kg
OPERATING_HEIGHT = 200 # 200 m
FIXED_WEIGHT = PAYLOAD 
...
DESCENT_TIME = time_to_land(OPERATING_HEIGHT)* 2
TOTAL_WEIGHT = PAYLOAD * 2 + BATT_WEIGHT
TOTAL_ENERGY = BATT_WEIGHT * LIPO_SPEC_ENG
ENERGY_CRUISE =  TOTAL_ENERGY - ((VEHICLE_SPEC_POW_CON * 1.5) * (CLIMB_TIME + DESCENT_TIME) * TOTAL_WEIGHT)
CRUISE_TIME = ENERGY_CRUISE / VEHICLE_SPEC_POW_CON

RANGE = CRUISE_TIME * WPNAV_SPEED
print(RANGE / 2)
